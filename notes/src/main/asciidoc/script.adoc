...
* Konfigurere redis til å serialisere som JSON:
...
* Vis testspesifikk testdata:

[source,sql]
----
include::{examples}/demo-webjpa/src/test/resources/db/migration/V201803122037__add_some_test_data.sql[]
----
