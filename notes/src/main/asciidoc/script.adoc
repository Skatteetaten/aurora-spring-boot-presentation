...
[source,xml]
----
include::{examples}/demo-webcache/pom.xml[tag=dep-cache]
----
[source,java]
----
...
[source,xml]
----
include::{examples}/demo-webcache/pom.xml[tag=dep-redis]
----
...
[source,sql]
----
include::{examples}/demo-webjdbc/src/main/resources/db/migration/V20180409203000__create_contact_table.sql[]
----

* Legge på JDBC driver
[source,java]
----
include::{examples}/demo-webjdbc/pom.xml[tag=dep-jdbc]
----
...
[source,java]
----
include::{examples}/demo-webjdbc/pom.xml[tag=dep-flyway]
----
